 ...
 * @copyright	Author
 */
alert("You are attempting to view this site in Internet Explorer 6, an outdated web browser. As a consequence, many elements may display incorrectly. To ensure the proper display of this website, please upgrade your browser to the latest version or download the Firefox or Google Chrome browsers.");
